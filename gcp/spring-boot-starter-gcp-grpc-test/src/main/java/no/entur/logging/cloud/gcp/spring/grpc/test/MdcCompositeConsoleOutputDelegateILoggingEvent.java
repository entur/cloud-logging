...
import no.entur.logging.cloud.logback.logstash.test.CompositeConsoleOutputDelegateILoggingEvent;
...
public class MdcCompositeConsoleOutputDelegateILoggingEvent implements CompositeConsoleOutputDelegateILoggingEvent {
    ...
    public MdcCompositeConsoleOutputDelegateILoggingEvent(ILoggingEvent event, CompositeConsoleOutputType compositeConsoleOutputType, Map<String, String> grpcMdcContext) {
        this.event = event;
