...
public class LoadOndemandContextLoggingTest {
    ...
    public void testOndemandMachineReadableJson() throws IOException, InterruptedException {
        ...
        LoggingScope loggingScope = loggingScopeFactory.openScope(queuePredicate, ignorePredicate);
        ...
        LOGGER.warn("Test warn message, this message should printed at once");
        LOGGER.error("Test error message, this message should printed at once");

        LOGGER.errorTellMeTomorrow("Test error tell me tomorrow message, this message should printet at once");
        LOGGER.errorInterruptMyDinner("Test error interrupt my dinner message, this message should printed at once");
        LOGGER.errorWakeMeUpRightNow("Test error wake me up right now message, this message should printed at once");

        System.out.println("Before flush");
        Thread.sleep(5000);
        appender.write(loggingScope);
        System.out.println("After flush");
        loggingScopeFactory.closeScope(loggingScope);
    }
