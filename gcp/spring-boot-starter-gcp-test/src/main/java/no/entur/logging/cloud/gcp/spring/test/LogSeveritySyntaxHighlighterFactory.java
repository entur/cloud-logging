...
public class LogSeveritySyntaxHighlighterFactory extends ConfigurableSyntaxHighlighterFactory {
	...
	public SyntaxHighlighter createSyntaxHighlighter(JsonGenerator generator) {
		...
		return new LogSeveritySyntaxHighlighter(cachedSyntaxHighlighter, severity.defaultValue, severity.debug, severity.info, severity.warning, severity.error, severity.critical, severity.alert, severity.emergency, message);
	}
