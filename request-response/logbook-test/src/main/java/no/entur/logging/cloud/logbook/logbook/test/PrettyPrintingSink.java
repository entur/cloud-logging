...
public class PrettyPrintingSink extends LogLevelLogstashLogbackSink {
    ...
    public PrettyPrintingSink(BooleanSupplier logLevelEnabled, BiConsumer<Marker, String> logConsumer, ValidateWellformedRequestBodyDecisionSupplier validateRequestJsonBody, ValidateWellformedResponseBodyDecisionSupplier validateResponseJsonBody, int maxBodySize, int maxSize, JsonFactory jsonFactory, SyntaxHighlighter syntaxHighlighter) {
