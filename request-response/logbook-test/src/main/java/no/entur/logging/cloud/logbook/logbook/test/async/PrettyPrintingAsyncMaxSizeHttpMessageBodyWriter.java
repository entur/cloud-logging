...
public class PrettyPrintingAsyncMaxSizeHttpMessageBodyWriter extends PrettyPrintingMaxSizeHttpMessageBodyWriter {

    protected final HttpMessageStateSupplier httpMessageStateSupplier;

    public PrettyPrintingAsyncMaxSizeHttpMessageBodyWriter(JsonFactory jsonFactory, byte[] input, int maxSize, HttpMessageStateSupplier httpMessageStateSupplier) {
