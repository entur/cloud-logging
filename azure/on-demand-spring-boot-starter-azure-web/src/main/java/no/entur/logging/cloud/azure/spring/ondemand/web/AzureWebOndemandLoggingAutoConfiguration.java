package no.entur.logging.cloud.azure.spring.ondemand.web;
...
import no.entur.logging.cloud.azure.spring.ondemand.web.properties.*;
import no.entur.logging.cloud.azure.spring.ondemand.web.scope.*;
...
public class AzureWebOndemandLoggingAutoConfiguration {

    private static final Logger LOGGER = (Logger) LoggerFactory.getLogger(AzureWebOndemandLoggingAutoConfiguration.class);
